<header class="w-screen h-[400px] flex justify-center items-center relative">
    ...
    <div class="bottom-0 bg-blue-600 left-0 absolute w-full z-20">
        <div class="text-white text-lg flex items-center gap-3 h-full px-8 py-4 bg-blue-800 w-fit"><a href="/">Home</a> <span class="text-sm">>></span><h3 class="text-white">{{$slug ?? $slot}}</h3></h>
    </div>
</header>